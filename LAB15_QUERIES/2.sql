...
[Тип_Aудитории].AUDITORIUM_TYPE [Тип_аудитории],
[Аудитория].AUDITORIUM_CAPACITY [Вместимость_аудитории]
from AUDITORIUM [Аудитория] join AUDITORIUM_TYPE [Тип_Aудитории]
	on [Аудитория].AUDITORIUM_TYPE=[Тип_Aудитории].AUDITORIUM_TYPE
